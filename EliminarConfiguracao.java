...
Número: 34298
Ficheiro: EliminarConfiguracao.java
Data: 31.07.2025
***********************************/
import javax.swing.*;
...
public class EliminarConfiguracao extends JFrame
{
    private PainelCentro centro;
    private PainelSul sul;
    
    public EliminarConfiguracao()
    {
        super("Pesquisas das Configuracoes para Eliminacao");
            ...
            {    
                ...
                if(centro.getTipoPesquisa() == 1)
                {
                    ...
                    if(opcao == JOptionPane.YES_OPTION)
                    {
                        ...
                        new ConfiguracaoFile().eliminarDados(modelo);
                        dispose();
                    }
                    else    
