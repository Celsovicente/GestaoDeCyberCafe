...
Número: 34298
Ficheiro: PesquisarEstacao.java
Data: 31.07.2025
***********************************/
import javax.swing.*;
...
public class PesquisarEstacao extends JFrame
{
    private PainelCentro centro;
    private PainelSul sul;
    
    public PesquisarEstacao()
    {
        super("Pesquisas das Estacoes");
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            {    
                if(centro.getTipoPesquisa() == 1)
                    EstacaoFile.pesquisarPorId(centro.getIdProcurado());
                else if(centro.getTipoPesquisa() == 2)
                    EstacaoFile.pesquisarPorEstado(centro.getEstadoProcurado());
            }
            else 
                dispose();
        }
