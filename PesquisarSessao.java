...
public class PesquisarSessao extends JFrame
{
    private PainelCentro centro;
    private PainelSul sul;
    
    public PesquisarSessao()
    {
        super("Pesquisas das Sessoes");
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            {    
                if(centro.getTipoPesquisa() == 1)
                    SessaoFile.pesquisarPorId(centro.getIdProcurado());
                else if(centro.getTipoPesquisa() == 2)
                    SessaoFile.pesquisarPorHorario(centro.getHoraProcurada());
            }
            else 
                dispose();
        }
